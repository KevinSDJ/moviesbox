...
export default function Navbar () {
  ...
  return (<>
    <Container as={'nav'} maxW={'full'} pos={(screensize > 900 && 'fixed') || 'relative'} zIndex={20} backgroundColor={(screensize > 900 && 'transparent') || '#2b2d42'}>
      ...
      <Link to="/">
        ...
        <Text as='strong' fontSize={(screensize < 900 && 'md') || 'xx-large'} color={'#1f5ea7'}>plus</Text>
        </Heading>
        </Link>
        <Spacer />
        <SearchDraw/>
